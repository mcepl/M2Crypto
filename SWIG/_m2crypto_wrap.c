...
#define SWIGTYPE_p_p_unsigned_char swig_types[48]
#define SWIGTYPE_p_stack_st swig_types[49]
#define SWIGTYPE_p_stack_st_OPENSSL_BLOCK swig_types[50]
#define SWIGTYPE_p_stack_st_OPENSSL_STRING swig_types[51]
#define SWIGTYPE_p_stack_st_SSL_CIPHER swig_types[52]
#define SWIGTYPE_p_stack_st_X509 swig_types[53]
#define SWIGTYPE_p_stack_st_X509_EXTENSION swig_types[54]
