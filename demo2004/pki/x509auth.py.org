...
class CertHandler:
    ...
    def PKeyFromPemRepr ( self, ObjName=None, PemPKey=None ):
        ...
        if self.PemMap.has_key( ObjName ):
            ...
            if not PemPKey:
                ...
                UsedPemPKey = PemPKey
        self.CurrentObj['RsaPKey']   = M2Crypto.RSA.load_key_repr( UsedPemPKey, callback )
    ...
    def CertFromPemRepr ( self, ObjName=None, PemCert=None ):
        if self.PemMap.has_key( ObjName ):
            ...
            UsedPemCert = PemCert
        self.CurrentObj['X509Cert']  = M2Crypto.X509.load_cert_pem_repr( PemCert )
    ...
    def ObjNameFromPemCert ( self, PemCert=None ):
        ...
        """
        X509Cert   = M2Crypto.X509.load_cert_pem_repr( PemCert )
    ...
    def ServerInitVerify ( self, InitString, ObjName=None ):
        ...
        try:
            X509Cert = M2Crypto.X509.load_cert_pem_repr( PemServerCert )
        except:
            return False
